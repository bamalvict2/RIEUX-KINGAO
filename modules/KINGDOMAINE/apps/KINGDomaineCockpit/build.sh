...
cd "$DOCKER"
docker build -f Dockerfile.Cockpit \
    -t kingdomaine-cockpit:latest \
    -t kingdomaine-cockpit:$HASH \
    "$APPS/$APP"

echo "=== BUILD TERMINÉ ==="
echo "Image générée : kingdomaine-cockpit:$HASH"
