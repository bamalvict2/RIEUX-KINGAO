...
/usr/bin/docker compose -f /opt/KING-AO/modules/EPARVIER/docker-compose-metier.yml up -d
#!/bin/bash
echo "🚀 EPARVIER : lancement cockpitifié"
docker compose -f /opt/KING-AO/modules/EPARVIER/docker-compose-metier.yml up -d
